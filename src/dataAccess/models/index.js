...
import apiUsageModel from './apiUsage.js';
...
const createModels = (sequelize) => {
    ...
    models.ApiUsage = apiUsageModel(sequelize, DataTypes);
...
export const { Player, Game, Card, Score, GamePlayer, Registry, ApiUsage } = models;
