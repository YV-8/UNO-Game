...
describe('GameService', () => {
    ...
    describe('endGame', () => {
        ...
        it('debe lanzar error 400 si el juego no está in_progress', async () => {
            // Arrange
            verifyAccessToken.mockReturnValue({ id: 1 });
            GameRepository.findById.mockResolvedValue({ id: 1, creatorId: 1, state: 'waiting' });
        ...
        it('debe finalizar el juego correctamente', async () => {
            // Arrange
            verifyAccessToken.mockReturnValue({ id: 1 });
            GameRepository.findById.mockResolvedValue({ id: 1, creatorId: 1, state: 'in_progress' });
            GameRepository.update.mockResolvedValue({});
    ...
    describe('joinGame', () => {
        ...
        it('debe lanzar error 400 si el juego ya finalizó', async () => {
            // Arrange
            verifyAccessToken.mockReturnValue({ id: 1, username: 'moni' });
        ...
        it('debe lanzar error 400 si el jugador ya está activo en el juego', async () => {
            // Arrange
            verifyAccessToken.mockReturnValue({ id: 1, username: 'moni' });
        ...
        it('debe reactivar al jugador si había salido antes (hasLeft true)', async () => {
            // Arrange
            verifyAccessToken.mockReturnValue({ id: 1, username: 'moni' });
            GameRepository.findById.mockResolvedValue({ id: 1, state: 'in_progress' });
        ...
        it('debe lanzar error 400 si el juego ya inició y el jugador nunca se unió antes', async () => {
            // Arrange
            verifyAccessToken.mockReturnValue({ id: 1, username: 'moni' });
            GameRepository.findById.mockResolvedValue({ id: 1, state: 'in_progress' });
        ...
        it('debe crear un nuevo gamePlayer si el juego está en waiting y nunca se unió', async () => {
            // Arrange
            verifyAccessToken.mockReturnValue({ id: 1, username: 'moni' });
            GameRepository.findById.mockResolvedValue({ id: 1, state: 'waiting' });
            GamePlayerRepository.findByGameAndPlayer.mockResolvedValue(null);
    ...
    describe('leaveGame', () => {
        ...
        it('debe lanzar error 400 si el jugador no está activo en el juego', async () => {
            // Arrange
            verifyAccessToken.mockReturnValue({ id: 1 });
            GameRepository.findById.mockResolvedValue({ id: 1 });
            GamePlayerRepository.findByGameAndPlayer.mockResolvedValue(null);
        ...
        it('debe lanzar error 400 si el jugador ya había salido antes', async () => {
            // Arrange
            verifyAccessToken.mockReturnValue({ id: 1 });
            GameRepository.findById.mockResolvedValue({ id: 1 });
            GamePlayerRepository.findByGameAndPlayer.mockResolvedValue({ id: 5, hasLeft: true });
        ...
        it('debe marcar hasLeft en true correctamente', async () => {
            // Arrange
            verifyAccessToken.mockReturnValue({ id: 1 });
            GameRepository.findById.mockResolvedValue({ id: 1 });
            GamePlayerRepository.findByGameAndPlayer.mockResolvedValue({ id: 5, hasLeft: false });
